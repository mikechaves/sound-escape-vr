...
public class SampleManager2 : MonoBehaviour {
   ...
   public static SampleManager2 Instance { get; set; }
   #endregion
   ...
   private string[] defaultSoundAssetnames = new string[4] {
      "80sSynthwave/Kick_20",
      "80sSynthwave/Snare_9",
      "80sSynthwave/SynthTom02",
      "80sSynthwave/Hihat_open_2"
   };
   ...
   private string stateKey = "soundState";
    ...
    void Awake() {
      if (SampleManager2.Instance == null)
         SampleManager2.Instance = this;
   }
