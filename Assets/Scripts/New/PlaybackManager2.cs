...
public class PlaybackManager2 : MonoBehaviour {

   #region Static Properties
   public static PlaybackManager2 Instance { get; set; }
   #endregion
   ...
   void Awake() {
      if (PlaybackManager2.Instance == null)
         PlaybackManager2.Instance = this;
   }

   // Use this for initialization
   void Start() {
      playing = false;
      numSlots = TileManager2.Instance.nSlots;
      numChannels = TileManager2.Instance.nChannels;
   ...
   public void TempoSet(int bpmNew) {
      ...
      DisplayManager2.Instance.SetTempo(bpmCurr);
      SaveState();
   }
   ...
   public void Update() {
      ...
      for (int i = 0; i < numChannels; i++) {
         if (!TileManager2.Instance.Tiles[i, computedSlot].PlayState)
            continue;

         // play the note and show the visual
         SampleManager2.Instance.StopSample(i);
         SampleManager2.Instance.PlaySample(i, nextBeatTime);
         TileManager2.Instance.Tiles[i, computedSlot].OnPlayHit();
      }
